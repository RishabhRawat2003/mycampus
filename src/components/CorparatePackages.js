      ...
      <div className="p-5 md:p-10">
        ...
        <div className="mt-10">
          <div className="text-4xl font-bold py-6">
            <h1 className="text-3xl sm:text-4xl font-semibold text-gray-700 tracking-wide">A wonderful dive into indias cultura and</h1>
            <h1 className="text-3xl sm:text-4xl font-semibold text-gray-700 tracking-wide">history</h1>
          </div>
...
export default CorparatePackages
