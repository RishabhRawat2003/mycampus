...
const Footer = () => {
  ...
  return (
    <>
      <div className="bg-[#DBF3FA] w-[90%] sm:w-[80%] 2xl:p-20 border-[1px] mx-auto border-gray-500 h-auto relative shadow-xl rounded-2xl py-10 px-5 sm:px-10">
        ...
        <div className="w-full h-auto flex justify-center items-center">
          <Link to={'/contactus'} className="px-14 py-3 bg-[#00A5CF] text-white rounded-lg font-semibold">
            Book Your Trip
          </Link>
        </div>

      </div>
      <div className="bg-slate-800 w-full flex flex-col items-center justify-center py-10 relative bottom-0 left-0 mt-10">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-8 lg:gap-20 xl:gap-40 2xl:gap-60 mt-10 text-white">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <Link to={'/'}><li>Experiential programs</li></Link>
              <Link to={'/'}><li> Our best selling tours</li></Link>
              <Link to={'/blogs'}><li>Blogs</li></Link>
              <Link to={'/'}><li>Customer testimonials</li></Link>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>We Are Hiring</li>
              <Link to='https://www.instagram.com/mycampussafari/'><li>Join Our Community</li></Link>
              <li>Why Us</li>
            </ul>
          </div>
        ...
        <div className="w-[75%] py-8 border-b-2">
          <div className="flex justify-center space-x-6 items-center mb-6">
            ...
            <Link to='https://www.linkedin.com/in/mycampus-safari-a25ab5343/'><FaTwitter className="text-white text-2xl sm:text-3xl cursor-pointer hover:text-gray-300" /></Link>
