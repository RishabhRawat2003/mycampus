...
import CollageImageComtent from './CollageImageComtent';
import { Link } from 'react-router-dom';

const CollagePackages = () => {
    return (
        <>
            <div className="">
                ...
                <div className="p-5 md:p-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[40%,60%] gap-4 mt-3">
                        <div className="relative pe-4">
                            <Link to={'/educational-tour'} onClick={() => { window.scroll(0, 0) }}>
                                <img
                                    ...
                                    <Link to={'/educational-tour'} onClick={() => { window.scroll(0, 0) }}>
                                        <div key={index} className="relative pe-4">
                                            <img
                                                ...
                                                alt=""
                                            />
                                            <div className="absolute inset-0 top-20 md:top-36 p-2 md:p-3">
                                                <h1 className="text-white text-sm md:text-md font-bold w-24 md:w-24">
                                                    {data?.name}
                                                </h1>
                                    ...
                                    <Link to={'/educational-tour'} onClick={() => { window.scroll(0, 0) }}>
                                        ...
                                        >
                                            <img
                                                src={elm}
                                                alt=""
                                                className="w-[400px] h-[300px] sm:h-[300px] rounded-t-lg object-cover"
                                            />
                    ...
                    <div className="mt-10 ">
                        <div className="py-6 w-full sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%]">
                            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-gray-700 tracking-wide lg:text-left">
                                A wonderful dive into India's culture and history
                            </h1>
                        </div>
...
export default CollagePackages
